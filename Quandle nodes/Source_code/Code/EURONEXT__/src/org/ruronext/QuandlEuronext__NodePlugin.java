 ...
 * @author Heng Chi
 */
public class QuandlEuronext__NodePlugin extends Plugin {
    // The shared instance.
    private static QuandlEuronext__NodePlugin plugin;

    /**
     * The constructor.
     */
    public QuandlEuronext__NodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static QuandlEuronext__NodePlugin getDefault() {
        return plugin;
    }
