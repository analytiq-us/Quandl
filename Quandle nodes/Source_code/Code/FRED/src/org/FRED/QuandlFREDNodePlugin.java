 ...
 * @author VIDHYA
 */
public class QuandlFREDNodePlugin extends Plugin {
    // The shared instance.
    private static QuandlFREDNodePlugin plugin;

    /**
     * The constructor.
     */
    public QuandlFREDNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static QuandlFREDNodePlugin getDefault() {
        return plugin;
    }
