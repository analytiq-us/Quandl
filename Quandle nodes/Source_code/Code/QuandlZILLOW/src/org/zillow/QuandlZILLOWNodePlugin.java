 ...
 */
public class QuandlZILLOWNodePlugin extends Plugin {
    // The shared instance.
    private static QuandlZILLOWNodePlugin plugin;

    /**
     * The constructor.
     */
    public QuandlZILLOWNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static QuandlZILLOWNodePlugin getDefault() {
        return plugin;
    }
