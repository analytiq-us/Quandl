...
public class QuandlEod__Config {

	private String m_api_key; // mdJ3-9txxdtZdZRH4HXJ
	...
	public QuandlEod__Config() {

		m_api_key = "mdJ3-9txxdtZdZRH4HXJ"; //mdJ3-9txxdtZdZRH4HXJ
		m_start_date = "";
		m_end_date = "";
	    m_tickers = "";
	}
